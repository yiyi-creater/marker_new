from flask import Flask, render_template_string, request, jsonify, send_file, redirect, url_for, Response, make_response
import csv
import os
import zipfile
...
<div class="container">
  <form action="/download_selected" method="post">
    <label style="margin-top: 0.5em; font-size: 0.5em;">选择要下载的日期（可多选）</label>
    <select name="dates" multiple size="4">
